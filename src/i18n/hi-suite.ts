...
export const hiSuite: Record<string, string> = {
  ...
  'offer-goes-cold.title': 'Offer Goes Cold Survival Guide',
  'offer-goes-cold.desc': 'क्या करें जब notice period के दौरान नई company शांत हो जाए।',
  'offer-goes-cold.verdict': 'recruiter का शांत होना आमतौर पर slow paperwork होता है। लेकिन अगर यह जारी रहता है, तो last working day से पहले writing में जवाब चाहिए।',
  'offer-goes-cold.s1.title': 'शांत होने का मतलब (और क्या नहीं)',
  'offer-goes-cold.s1.body': 'Silence का मतलब हमेशा यह नहीं होता कि offer खत्म हो गया है। Paperwork में देरी, BGV sign-off, budget approval, या recruiter का job बदलना आम बातें हैं। लेकिन सब कुछ ठीक है, यह मानकर न बैठें। आपको writing में confirmed joining date चाहिए।',
  'offer-goes-cold.s2.title': 'पहले 48 घंटे: क्या पूछें',
  'offer-goes-cold.s2.body': 'Recruiter, hiring manager, और HR से writing में update मांगें। एक असली जवाब में written joining date, साफ BGV status, या एक named HR contact होता है। Phone पर vague भरोसे जवाब नहीं हैं।',
  'offer-goes-cold.s3.title': 'Slow बनाम cold',
  'offer-goes-cold.s3.body': 'अगर वे एक खास वजह और timeline के साथ reply करते हैं, तो यह slow है। अगर emails ignore हो रहे हैं, hiring manager बिना जवाब दिए आपको HR के पास भेज रहा है, या बार-बार "we will get back to you" सुन रहे हैं, तो यह cold हो रहा है।',
  'offer-goes-cold.s4.title': 'Plan B चालू रखना',
  'offer-goes-cold.s4.body.1': 'अपनी job search तुरंत चुपचाप फिर से शुरू करें। अपने current manager को अपनी चिंता न बताएं। नए leads को जल्दी evaluate करने के लिए',
  'offer-goes-cold.s4.fakeOffer': 'Fake Offer Scanner',
  'offer-goes-cold.s4.and': 'और',
  'offer-goes-cold.s4.offerComparison': 'Offer Comparison',
  'offer-goes-cold.s4.body.2': 'tools का इस्तेमाल करें। आपकी priority options रखना है।',
  'offer-goes-cold.s5.title': 'आपकी current employer',
  'offer-goes-cold.s5.body': 'आप अपने manager से notice extend करने या रुकने के बारे में बात कर सकते हैं। इसे एक बातचीत की तरह रखें। वे इसे allow करते हैं या नहीं, यह पूरी तरह उनका फैसला है। Withdrawal policies के लिए अपना appointment letter चेक करें, या जरूरत हो तो lawyer से सलाह लें।',
  'offer-goes-cold.s6.title': 'पैसा और runway',
  'offer-goes-cold.s6.body.1': 'अगर joining date अनिश्चित काल के लिए खिसक जाती है, तो हिसाब लगाएं कि आप कितने महीने survive कर सकते हैं। अपने immediate runway की planning के लिए final settlement का अंदाज़ा लगाने के लिए',
  'offer-goes-cold.s6.fnfChecker': 'F&F Checker',
  'offer-goes-cold.s6.body.2': 'का इस्तेमाल करें।',
  ...
  'offer-goes-cold.prompt.text': 'Draft a calm, professional follow-up email to the recruiter [Recruiter Name] and hiring manager [Manager Name] at [Company Name]. I resigned from my current job on [Resignation Date] based on their offer. They have not replied to my emails for the last [Number of days] days. I need them to confirm my joining date and BGV status in writing. Keep it short, polite, but firm. Do not sound desperate.',
};
