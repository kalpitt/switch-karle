...
export const hi: Record<string, string> = {
  ...
  'tracker.archive': 'Archive करें',
  'tracker.archive.why': 'यह क्यों बंद हुआ?',
  'tracker.archive.rejected': 'Rejected',
  'tracker.archive.ghosted': 'Ghosted',
  'tracker.archive.withdrawn': 'Withdrawn',
  'tracker.archive.count': 'Archived ({count})',
  'tracker.archive.closedDate': '{date} को बंद',
  'tracker.archive.restore': 'वापस लाएं',
  ...
  'sweep.found': 'जोड़ने के लिए तैयार: {n}',
