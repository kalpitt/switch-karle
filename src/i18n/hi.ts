...
export const hi: Record<string, string> = {
  ...
  'sweep.title': 'अपना board mailbox से भरें',
  'sweep.step1': 'इसे copy करें और अपने उसी AI में चलाएँ जो आपके Gmail से जुड़ा है।',
  'sweep.copy': 'Prompt copy करें',
  'sweep.copied': 'Copy हो गया',
  'sweep.privacy': 'यहाँ से कुछ भी नहीं भेजा जाता। Search आप अपने ही account में चलाते हैं और जवाब खुद वापस paste करते हैं।',
  'sweep.step2': 'जो जवाब मिले उसे यहाँ paste करें',
  'sweep.read': 'पढ़ें',
  'sweep.invalid': 'यह वैसा JSON नहीं लग रहा जैसा prompt माँगता है। पूरा जवाब paste करें, braces समेत।',
  'sweep.found': '{n} applications जोड़ने के लिए तैयार हैं।',
  'sweep.looksClosed': 'बंद लगती है',
  'sweep.skipped.alreadyOnBoard': '{n} पहले से आपके board पर हैं।',
  'sweep.skipped.outOfScope': '{n} पिछले 60 दिनों से बाहर की हैं।',
  'sweep.skipped.duplicateInPayload': '{n} दो बार आई थीं।',
  'sweep.skipped.unreadableDate': '{n} की date पढ़ी नहीं जा सकी।',
  'sweep.skipped.noCompany': '{n} में company का नाम नहीं था।',
