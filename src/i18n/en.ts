...
export const en: Record<string, string> = {
  ...
  'offer-goes-cold.s1.body': 'Silence does not automatically mean the offer is dead. Delays in paperwork, BGV sign-offs, budget approvals, or a recruiter leaving are common. However, do not assume everything is fine. You need a confirmed joining date in writing.',
  'offer-goes-cold.s2.title': 'The first 48 hours: What to ask',
  'offer-goes-cold.s2.body': 'Ask the recruiter, hiring manager, and HR in writing for an update. A real answer includes a written joining date, a clear BGV status, or a named HR contact. Vague assurances on the phone are not answers.',
  'offer-goes-cold.s3.title': 'Slow versus cold',
  'offer-goes-cold.s3.body': 'It is slow if they reply with a specific bottleneck and timeline. It is going cold if emails are ignored, the hiring manager redirects you to HR without answering, or you get repeated generic "we will get back to you" replies.',
  'offer-goes-cold.s4.title': 'Keeping a Plan B running',
  'offer-goes-cold.s4.body.1': 'Quietly restart your job search immediately. Do not tell your current manager you are worried. Use the',
  'offer-goes-cold.s4.fakeOffer': 'Fake Offer Scanner',
  'offer-goes-cold.s4.and': 'and',
  'offer-goes-cold.s4.offerComparison': 'Offer Comparison',
  'offer-goes-cold.s4.body.2': 'tools to evaluate new leads fast. Your priority is having options.',
  'offer-goes-cold.s5.title': 'Your current employer',
  'offer-goes-cold.s5.body': 'You can ask your manager about extending your notice or staying on. Frame it as a conversation. Whether they allow it is entirely their call. Check your appointment letter for withdrawal policies, or consult a lawyer if needed.',
  'offer-goes-cold.s6.title': 'Money and the runway',
  'offer-goes-cold.s6.body.1': 'Work out how many months you can survive if the joining date slips indefinitely. Use the',
  'offer-goes-cold.s6.fnfChecker': 'F&F Checker',
  'offer-goes-cold.s6.body.2': 'to estimate your final settlement payout to plan your immediate runway.',
