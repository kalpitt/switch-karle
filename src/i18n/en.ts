...
export const en: Record<string, string> = {
  ...
  'bonus-clawback.creditDate': 'Bonus credited on',
  'bonus-clawback.creditDateHint': 'The day it reached your account. The window runs from here, not from your join date.',
  'bonus-clawback.plannedLwd': 'Planned last working day',
  'bonus-clawback.plannedLwdHint': 'Leaving three weeks short of the anniversary still counts as short.',
  'bonus-clawback.taxableIncome': 'Taxable income without the bonus',
  'bonus-clawback.taxableIncomeHint': 'Seeded from your Decoder offer. Change it if your actual income differs.',
  'bonus-clawback.regime': 'Tax regime',
  'bonus-clawback.served': '{months} months served against a {window}-month window.',
  ...
  'esop-reality.cadence': 'How it vests',
  'esop-reality.cadence.monthly': 'Monthly',
  'esop-reality.cadence.annual': 'Annually',
  'esop-reality.vestLinear': 'Modelled as a monthly vest: shares × month ÷ vest period, once the cliff passes.',
  'esop-reality.vestAnnual': 'Modelled as equal annual tranches — one at the cliff, one on each anniversary after it. Nothing accrues in between, however long you stay.',
  'esop-reality.vestLetter': 'Your grant letter decides which of these is true. Neither reading parses it.',
  ...
  'tracker.example.title': 'This is what your board looks like once you add a few',
  'tracker.example.action.referral': 'Find someone who can refer you',
  ...
  'tracker.restore.replace': 'Replace',
  'tracker.restore.replaceHint': 'Discards your current board and uses the backup instead.',
  'tracker.restore.cancel': 'Cancel',
  'tracker.restore.merged': 'Merged. Your board kept everything it had.',
  'tracker.restore.replaced': 'Board replaced from the backup.',
  'tracker.restore.undo': 'Undo',
  'tracker.restore.invalid': 'That file is not a Switch Karle backup.',
  ...
  'tracker.archive.why': 'Why is this closed?',
  ...
  'tracker.archive.closedDate': 'Closed {date}',
  'tracker.archive.restore': 'Restore',
  'sweep.title': 'Fill your board from your mailbox',
  'sweep.step1': 'Copy this and run it in your own AI, the one connected to your Gmail.',
  'sweep.copy': 'Copy prompt',
  'sweep.copied': 'Copied',
  'sweep.privacy': 'Nothing is sent from here. You run the search in your own account and paste the answer back yourself.',
  'sweep.step2': 'Paste what it gives you back',
  'sweep.read': 'Read it',
  'sweep.invalid': 'That does not look like the JSON the prompt asks for. Paste the whole answer, including the braces.',
  'sweep.found': '{n} ready to add.',
  ...
  // ---- Offer Goes Cold Guide ----
    'offer-goes-cold.title': 'When the new offer goes quiet',
  'offer-goes-cold.desc': 'What to do when the new company goes quiet during your notice period.',
  'offer-goes-cold.verdict': 'A quiet recruiter is usually slow paperwork. But if it lasts, you need answers in writing before your last working day.',
  'offer-goes-cold.s1.title': 'What quiet usually means (and what it does not)',
  'offer-goes-cold.s1.body.1': 'Silence does not automatically mean the offer is dead. Paperwork, BGV, budget approvals or a recruiter changing jobs often slow things down. But do not assume everything is fine either. You need a confirmed joining date in writing. Reread the offer letter itself for a validity date or conditions. If BGV is the hold-up, your previous employer\'s HR can be the slow party: see ',
  'offer-goes-cold.s1.and': ' and ',
  'offer-goes-cold.s1.body.2': '.',
  'offer-goes-cold.s2.title': 'The first week: what to ask',
  'offer-goes-cold.s2.body': 'Ask the recruiter, the hiring manager and HR, in writing, for an update. A real answer is a written joining date, a clear BGV status, or a named HR contact. Vague assurances on a call are not answers. If all three stay silent for more than a week, a short, factual message to someone more senior on that team is a normal next step. Not an accusation, just the facts and the date you need an answer by.',
  'offer-goes-cold.s3.title': 'Slow versus cold',
  'offer-goes-cold.s3.body': 'It is slow if they reply with a specific bottleneck and timeline. It is going cold if emails are ignored, the hiring manager redirects you to HR without answering, or you get repeated generic "we will get back to you" replies. Keep every email. Write down each verbal promise, with the date, right after the call.',
  'offer-goes-cold.s4.title': 'Keeping a Plan B running',
  'offer-goes-cold.s4.body.1': 'Quietly restart your search now. Put new leads on your ',
  'offer-goes-cold.s4.body.2': ' so nothing slips. Do not tell your current manager you are worried. Your priority is having options.',
  'offer-goes-cold.s5.title': 'Your current employer',
  'offer-goes-cold.s5.body.1': 'Do not raise an extension or a reversal while you are only worried. It signals that the new offer may be shaky, and it cannot be unsaid. If your last day is close and you truly need more time, ask only for a short extension, framed as a scheduling request. Offer to withdraw your resignation only if you have decided you would really stay. Your team may already be hiring your replacement, and it is their call either way. Check what your appointment letter says about withdrawing a resignation; the ',
  'offer-goes-cold.s5.body.2': ' helps you read the clauses you signed. Whatever happens with the new offer, keep this exit clean. You will want your relieving letter either way.',
  'offer-goes-cold.s6.title': 'Money and the runway',
  'offer-goes-cold.s6.body.1': 'Work out how many months you can manage if the joining date keeps slipping. ',
  'offer-goes-cold.s6.body.2': ' tells you what your final settlement should be. Your group health cover usually ends on your last working day, even if the new job has not started: ',
  'offer-goes-cold.s6.body.3': ' shows what that leaves uncovered. ',
  'offer-goes-cold.s6.body.4': ' keeps every exit date in one place.',
  'offer-goes-cold.prompt.title': 'Follow-up email prompt',
  'offer-goes-cold.prompt.desc': 'Copy this prompt to your AI assistant (like ChatGPT) to draft a calm, professional follow-up email.',
